        ...
        <View style={styles.container}>
            ...
            <Image source={require('../assets/logo.png')} style={{height:100, width:100, resizeMode:'contain', alignSelf:'center'}}></Image>
              ...
              <View style={{marginTop:'10%', backgroundColor:'#FFF', alignSelf:'center', width:'100%'}}>
                ...
                <TouchableOpacity onPress={()=>navigation.navigate('Home')}><Text style={{fontFamily:'A', fontSize:20, textAlign:'center', alignSelf:'center', backgroundColor:'#e67f0d', color:'#FFF', width:'70%', paddingVertical:'4.5%', borderRadius:10, elevation:0, marginTop:'15%'}}>
                    LOGIN
                 ...
                 <TouchableOpacity><Text style={{fontFamily:'A', fontSize:17, textAlign:'center', color:'#e67f0d'}} onPress={()=>navigation.navigate('Register')}> here</Text></TouchableOpacity>
                </View>
